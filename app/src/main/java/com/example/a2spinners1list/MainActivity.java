...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, AdapterView.OnItemSelectedListener {
    ...
    String[]cityJapan={"Nagoya","Toyohashi","Okazaki","Ichinomiya","Seto"};
    String[]cityChina={"Beijing","Chongqing","Shanghai","Tianjin","Anqing"};
    String[]cityCambodia={"Phnom Penh","Siem Reap","Battambang","Preah Sihanouk","Serei Saophoan"};
    String[]cityCyprus={"nicosia","limassol","Strovolos","larnaca","Famagusta"};
    String[]cityTurkey={"istanbul","ankara","izmir","bursa","adana"};
    String[]cityIndia={"mumbai","delhi","bangalore","hyderbad","ahmedabad"};
    String[]cityArgentina={"buenos aires","cordoba","rosario","mendoza","tucuman"};
    String[]cityBrazil={"sao paulo","rio","distrito federal","bahia","ceara"};
    String[]cityCanada={"tornto","montreal","vancouver","calgary","edmonton"};
    String[]cityChile={};
    String[]cityColombia={};
    String[]cityMexico={};
    String[]cityPeru={};
